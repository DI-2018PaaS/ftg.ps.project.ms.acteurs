package ftg.ps.project.ms.acteurs.web.rest;

import ftg.ps.project.ms.acteurs.ActeurApp;

import ftg.ps.project.ms.acteurs.config.SecurityBeanOverrideConfiguration;

import ftg.ps.project.ms.acteurs.domain.AnimateurFournisseur;
import ftg.ps.project.ms.acteurs.repository.AnimateurFournisseurRepository;
import ftg.ps.project.ms.acteurs.web.rest.errors.ExceptionTranslator;
...
import static ftg.ps.project.ms.acteurs.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, ActeurApp.class})
public class AnimateurFournisseurResourceIntTest {
    ...
    public void updateAnimateurFournisseur() throws Exception {
        ...
        AnimateurFournisseur updatedAnimateurFournisseur = animateurFournisseurRepository.findById(animateurFournisseur.getId()).get();
