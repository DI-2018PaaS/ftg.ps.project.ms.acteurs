...
import ftg.ps.project.ms.acteurs.web.rest.errors.BadRequestAlertException;
import ftg.ps.project.ms.acteurs.web.rest.util.HeaderUtil;
...
public class AnimateurFournisseurResource {
    ...
    public ResponseEntity<AnimateurFournisseur> getAnimateurFournisseur(@PathVariable Long id) {
        ...
        Optional<AnimateurFournisseur> animateurFournisseur = animateurFournisseurRepository.findById(id);
        return ResponseUtil.wrapOrNotFound(animateurFournisseur);
    }
    ...
    public ResponseEntity<Void> deleteAnimateurFournisseur(@PathVariable Long id) {
        ...
        animateurFournisseurRepository.deleteById(id);
